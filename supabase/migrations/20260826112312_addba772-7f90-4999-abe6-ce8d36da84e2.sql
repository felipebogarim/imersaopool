  ...
  LOOP
    ...
    BEGIN
      ...
      FOREACH _f IN ARRAY _familias LOOP
        ...
        -- Meta ausente = família "Sem compra": recupera a meta da matriz da categoria.
        ...
        IF _meta_val IS NOT NULL AND _meta_val > 0 AND _real_val IS NULL THEN
          _real_val := 0;  -- Sem compra = venda zero (resultado válido).
        END IF;
