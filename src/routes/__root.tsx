...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Plataforma para preparar, conduzir e analisar imersões comerciais com diagnóstico IA." },
      ...
      { property: "og:description", content: "Plataforma para preparar, conduzir e analisar imersões comerciais com diagnóstico IA." },
      { name: "twitter:description", content: "Plataforma para preparar, conduzir e analisar imersões comerciais com diagnóstico IA." },
