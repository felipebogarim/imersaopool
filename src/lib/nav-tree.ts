...
export const NAV_TREE: NavGroup[] = [
  { key: "bi", label: "BI", to: "/dashboard", children: [] },
  {
    key: "inputs",
    label: "Inputs",
    children: [
  ...
  },
  {
    ...
    label: "Análises",
    children: [
      { key: "analises.sintese-tipos", label: "Síntese por tipo", to: "/sintese/tipos" },
      { key: "analises.visao-rep", label: "Visão Rep (clássica)", to: "/visao-rep" },
